...
const routes = [
...

  {
    ...
    children: [
      ...
      {
        path: "post-test/:attempt",
        name: "Post Test",
        component: MemberPostTest,
      },
      {
        path: "attempt-test/:type",
        name: "Attempt Test",
        component: MemberAttemptTest,
      },
    ],
  },
